...
class Seq2SeqDecoder(d2l.Decoder):
    ...
    def forward(self, X, state):
        ...
        # Make the batch to be the first dimension to
...
print(loss(torch.ones((3, 4, 10)),
           torch.ones((3, 4), dtype=torch.long), torch.tensor([4, 3, 0])))
...
src_vocab, tgt_vocab, train_iter = \
    d2l.load_data_nmt(path_txt, batch_size, max_len, num_examples)
encoder = Seq2SeqEncoder(
